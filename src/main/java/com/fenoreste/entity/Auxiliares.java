...
public class Auxiliares{      
	...
	public String toString() {
		return "Auxiliares [idorigenp=" + idorigenp + ", idproducto=" + idproducto + ", idauxiliar=" + idauxiliar
				+ ", idorigen=" + idorigen + ", idgrupo=" + idgrupo + ", idsocio=" + idsocio + ", fechaape=" + fechaape
				...
				+ fechacartera + ", fechauma=" + fechauma + ", ivaidnccalc=" + ivaidnccalc + ", ivaidncpag="
				+ ivaidncpag + ", tiporeferencia=" + tiporeferencia + ", calificacion=" + calificacion
				+ ", pagodiafijo=" + pagodiafijo + ", iodif=" + iodif + ", garantia=" + garantia + ", saldodiacummi="
				+ saldodiacummi + ", comision=" + comision + ", fechasdiacum=" + fechasdiacum + ", prcComision="
				+ prcComision + ", sobreprecio=" + sobreprecio + ", comisionNp=" + comisionNp + ", pagosDiaUltimo="
				+ pagosDiaUltimo + ", tipoDv=" + tipoDv + ", fechaSolicitud=" + fechaSolicitud + ", fechaAutorizacion="
				+ fechaAutorizacion + ", idncm=" + idncm + ", iecom=" + iecom + ", reservaidncm=" + reservaidncm + "]";
	}
