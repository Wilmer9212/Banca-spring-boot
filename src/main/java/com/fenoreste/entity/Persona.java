...
public class Persona{
	...
	public String toString() {
		return "Persona [idorigen=" + idorigen + ", idgrupo=" + idgrupo + ", idsocio=" + idsocio + ", calle=" + calle
				+ ", numeroext=" + numeroext + ", numeroint=" + numeroint + ", entrecalles=" + entrecalles
				+ ", fechanacimiento=" + fechanacimiento + ", lugarnacimiento=" + lugarnacimiento + ", efnacimiento="
				+ efnacimiento + ", sexo=" + sexo + ", telefono=" + telefono + ", telefonorecados=" + telefonorecados
				+ ", listanegra=" + listanegra + ", estadocivil=" + estadocivil + ", idcoop=" + idcoop + ", idsector="
				+ idsector + ", estatus=" + estatus + ", aceptado=" + aceptado + ", fechaingreso=" + fechaingreso
				+ ", fecharetiro=" + fecharetiro + ", fechaciudad=" + fechaciudad + ", regimenMat=" + regimenMat
				+ ", nombre=" + nombre + ", medioInf=" + medioInf + ", requisitos=" + requisitos + ", appaterno="
				+ appaterno + ", apmaterno=" + apmaterno + ", nacionalidad=" + nacionalidad + ", gradoEstudios="
				+ gradoEstudios + ", categoria=" + categoria + ", rfc=" + rfc + ", curp=" + curp + ", email=" + email
				+ ", razonSocial=" + razonSocial + ", causaBaja=" + causaBaja + ", nivelRiesgo=" + nivelRiesgo
				+ ", celular=" + celular + ", rfcValido=" + rfcValido + ", curpValido=" + curpValido + ", idcolonia="
				+ idcolonia + "]";
	}
