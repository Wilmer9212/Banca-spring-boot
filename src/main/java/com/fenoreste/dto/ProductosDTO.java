...
public class ProductosDTO {
  ...
  public ProductosDTO(String clientBankIdentifier, String productBankIdentifier, String productNumber, int productStatusId, String productTypeId, String productAlias, String canTransact, String currencyId) {
