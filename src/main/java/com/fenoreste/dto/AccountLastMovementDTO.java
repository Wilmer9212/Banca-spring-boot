...
public class AccountLastMovementDTO {
    ...
    public AccountLastMovementDTO() {
    }

    public AccountLastMovementDTO(int MovementId, String AccountBankIdentifier, String MovementDate, String Description, Double Amount, boolean isDebit, Double Balance, int MovementTypeId, String TypeDescription, String CheckId, String VoucherId) {
