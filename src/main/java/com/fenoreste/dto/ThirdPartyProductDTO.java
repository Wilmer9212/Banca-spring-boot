...
public class ThirdPartyProductDTO {
	...
	public ThirdPartyProductDTO(ArrayList<String> clientBankIdentifiers, String thirdPartyProductNumber,
			String thirdPartyProductBankIdentifier, String alias, String currencyId, Integer transactionSubType,
			Integer thirdPartyProductType, Integer productType, String ownerName, String ownerCountryId,
			String ownerEmail, String ownerCity, String ownerAddress, UserDocumentIdDTO ownerDocumentId,
			String ownerPhoneNumber, Bank bank, Bank correspondentBank, UserDocumentIdDTO userDocumentId) {
		super();
	...
	public String toString() {
		return "ThirdPartyProductDTO [clientBankIdentifiers=" + clientBankIdentifiers + ", thirdPartyProductNumber="
				+ thirdPartyProductNumber + ", thirdPartyProductBankIdentifier=" + thirdPartyProductBankIdentifier
				+ ", alias=" + alias + ", currencyId=" + currencyId + ", transactionSubType=" + transactionSubType
				+ ", thirdPartyProductType=" + thirdPartyProductType + ", productType=" + productType + ", ownerName="
				+ ownerName + ", ownerCountryId=" + ownerCountryId + ", ownerEmail=" + ownerEmail + ", ownerCity="
				+ ownerCity + ", ownerAddress=" + ownerAddress + ", ownerDocumentId=" + ownerDocumentId
				+ ", ownerPhoneNumber=" + ownerPhoneNumber + ", bank=" + bank + ", correspondentBank="
				+ correspondentBank + ", userDocumentId=" + userDocumentId + "]";
	}
